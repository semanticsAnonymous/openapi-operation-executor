...
describe('OpenApiClientUtils', (): void => {
  ...
  //     setBasicAuthToObject(object, { username: 'semanticsanonymous' });
  //     expect(object.auth).toEqual({ username: 'semanticsanonymous', password: undefined });
  //     object = {};
  //     setBasicAuthToObject(object, { password: 'abc123' });
  //     expect(object.auth).toEqual({ username: undefined, password: 'abc123' });
  //     object = {};
  //     setBasicAuthToObject(object, { username: 'semanticsanonymous', password: 'abc123' });
  //     expect(object.auth).toEqual({ username: 'semanticsanonymous', password: 'abc123' });
  //   });
